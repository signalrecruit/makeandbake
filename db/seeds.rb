...
admin_super_one = {
	first_name: "Derek", last_name: "Owusu-Frimpong", username: "paayaw", email: "deepsky_5@live.com", password: "password", password_confirmation: "password",
 phonenumber: "0204704427", gender: "male", age: 28, admin: true, seller: true, admin_access_level: :super_admin
}

admin_super_two = {
	first_name: "jide", last_name: "Otoki", username: "username", email: "jideotoki@gmail.com", password: "password", password_confirmation: "password",
